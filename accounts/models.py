...
from gcutickets.utils.utils import unique_key_generator
...
class EmailActivation(models.Model):
    ...
    def send_activation(self):
        if not self.activated and not self.forced_expired:
            if self.key:
                base_url = getattr(settings, 'BASE_URL', 'https://www.gcu.com')
                ...
                subject = 'Glasgow Caledonian Audio Visual Servic'
